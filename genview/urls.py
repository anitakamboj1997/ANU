...
urlpatterns = [
    ...
    path('create', views.ContactCreate.as_view(success_url="/contacts"), name='contact_create'),
    path('update/<int:pk>', views.ContactUpdate.as_view(), name='contact_update'),
    path('delete/<int:pk>', views.ContactDelete.as_view(success_url="/contacts"), name='contact_delete',),
]